...
function get_particuler_studentdata()
{
    var class_id = document.getElementById("selected_class_id").value;
     var assecmenttype_id = "";
  
     var temp_parm = "class_id="+class_id+"&&assecmenttype_id="+assecmenttype_id;;
     
     
    xmlhttp = new XMLHttpRequest();
    xmlhttp.open("GET", "../../controller/super/ReloadClasses.php?id=4&&"+temp_parm, false);
    xmlhttp.send(null);
    document.getElementById("student_id").innerHTML = xmlhttp.responseText;
