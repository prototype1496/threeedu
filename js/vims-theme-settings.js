var site_settings = '<div class="ts-button">'
    ...
    +'</div>'
    +'<div class="ts-body">'
        +'<div class="ts-title">VIMS Theme Options</div>'  //theme option title ; rohim
        +'<div class="ts-row">'
        ...
        +'<div class="ts-row">'
            +'<label class="check"><input type="radio" class="iradio" name="st_layout_boxed" value="1" checked/> Full Width</label>'
        +'</div>'
        +'<div class="ts-row">'
		...
		//reference to different themes and their repective image(preview) rohim
        +'<div class="ts-themes">'
