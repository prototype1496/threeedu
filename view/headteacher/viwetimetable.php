                                                                            ...
                                                                            <div class="card">
                                                                                ...
                                                                                <div class="col-sm-12">
                                                                                    <div class="row">
                                                                                        ...
                                                                                        <div class="col-sm-12 col-xl-3 m-b-30">
                                                                                            <button class="btn btn-info" type="submit" name="btn_load_time_table_head">Load Time Table</button>
    ...
    <script type="028b4b5e88a856df25e89945-text/javascript" src="../../files/assets/js/script.js"></script>
                                                                                                    ...
                                                                                                    <script>
                                                                                                                function redirectWithID(id, day) {
                                                                                                                    window.location.href = "/threeedu/view/headteacher/edittimetable.php?id=" + id + "&&day=" + day;
