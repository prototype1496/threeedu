...
if(!isset($student_no)){
    ...
    header('Location:/threeedu/view/admin/viwestudent.php');
}

$row_data = SuperModel::get_student_details_by_student_no($student_no);
      ...
      <div class="row align-items-end ">
        ...
        <div class="card-block">
            <form enctype="multipart/form-data" method="POST" action="../../controller/admin/ActionPerformed.php" >
                ...
                <input type="hidden" value="<?php echo $student_no; ?>" name="student_no"/>
                
                
                <input type="hidden" value="<?php echo $row_data['StudentMasterPublicID'] ; ?>" name="student_master_public_id"/>
                <div class="form-group row">
                      <div class="col-md-4">
                        <div class="form-group">
                          <label class="bmd-label-floating">First Name</label>
                          <input value=" <?php echo $row_data['FirstName']; ?>" required="" name="first_name" type="text" class="form-control">
                        </div>
                      </div>
                      <div class="col-md-4">
                        <div class="form-group">
                          <label class="bmd-label-floating">Last Name</label>
                          <input required="" value=" <?php echo $row_data['LastName'] ; ?>"  name="last_name" type="text" class="form-control">
                        </div>
                      </div>
                      <div class="col-md-4">
                        <div class="form-group">
                          <label class="bmd-label-floating">Other Name</label>
                          <input name="other_name" value=" <?php echo $row_data['OtherName'] ; ?>" type="text" class="form-control">
                        </div>
                      </div>
                    </div>
                  ...
                  <div class="form-group row">
                          ...
                          <div class="form-select-list">
                               <label class="bmd-label-floating">Gender</label>
                                        <select required="" class="form-control custom-select-value" name="gender_id">
                                            <option value="<?php echo $row_data['GenderMasterID']; ?>"  selected="selected"><?php echo $row_data['Gender']; ?></option>
                      ...
                      <div class="col-md-4">
                        <div class="form-group">
                          ...
                          <input required="" value="<?php echo $row_data['OGDOB']; ?>" type="date"  name="dob" class="form-control" />
                        </div>
                      </div>
                        ...
                        <div class="form-group">
                          ...
                          <div class="form-select-list">
                                        <select  required="" class="form-control custom-select-value" name="marital_status_id">
                                            <option value="<?php echo $row_data['MaritalStatusID']; ?>"  selected="selected"><?php echo $row_data['MaritalStatus']; ?></option>
...
<!--                    <div class="col-md-4">
                         ...
                         <label class="bmd-label-floating">Profile Pic</label>
                              <input type="file" value="<?php echo $row_data['ProfilePic'] ; ?>" accept="image/png,image/jpeg" name="profile_pic" class="form-control" />
                        </div>
                      </div>-->
                        ...
                        <div class="form-group">
                          ...
                          <div class="form-select-list">
                              <select id="grade_id" onclick="get_class()"  required="" class="form-control custom-select-value" name="grade_id">
                                            <option value="<?php echo $row_data['GradeMasterID'] ; ?>" selected="selected"><?php echo $row_data['Grade'];?></option>
    ...
    <div class="card">
        ...
        <div class="card-block">
                ...
                <div class="form-group row">
                       ...
                       <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <input name="male_gardian_name" value="<?php echo $row_data['GuardianMaleName']; ?>" type="text" class="form-control"><br>
                        </div>
                      </div>
                       ...
                       <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <input name="female_gardian_name" value="<?php echo $row_data['GuardianFemaleName']; ?>" type="text" class="form-control"><br>
                        </div>
                      </div>
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <input required="" name="gardian_contact_no" value="<?php echo $row_data['ContactNo'] ; ?>" type="text" class="form-control"><br>
                        </div>
                      </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <input name="email_address" value="<?php echo $row_data['EmailAddress'] ; ?>" type="email" class="form-control"><br>
                        </div>
                      </div>
                      ...
                      <div class="col-md-12">
                        <div class="form-group">
                          ...
                          <textarea required="" type="date"   name="address" class="form-control"  rows="3" ><?php echo $row_data['Address']; ?></textarea>
                        </div>
                      </div>
            ...
            <button type="submit" name="btn_updat_pupil" class="btn btn-warning btn-round">Submit</button>
