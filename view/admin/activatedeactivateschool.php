...
include '../../controller/admin/SysAdminControler.php';
$tenant_id = $_SESSION['threeedu_tenantid'];
$stm = SysAdminModel::get_all_school_details();
?>
<!DOCTYPE html>
<html lang="en">
...
<head>
<title>Activate Deactivate School </title>
      ...
      <?php while($row = $stm->fetch(PDO::FETCH_ASSOC))
                            
                    {
                          $public_id = $row['PublicID'];
                            ?>
<tr>
     <td>   <img src="<?php echo $row['PicURL'];  ?>" class="img-chat-profile" alt="User-Profile-Image"></td>
...
<script>
 function redirectWithID(id){
     ...
     function redirectResetWithID(id){
         window.location.href = "activatedeactivateschool.php?schoolid="+id;
