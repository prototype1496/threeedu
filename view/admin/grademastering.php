...
$stm = SuperModel::get_grading_master_details_by_tenantId($tenant_id);
                                ...
                                <div class="pcoded-inner-content">
                                    <div class="main-body">
                                        <div class="page-wrapper">
                                            <div class="page-body">
                                                <!--    -->
                                                <form  enctype="multipart/form-data"   method="POST" action="grademastering.php" >

                                                    <button name="btn_class_grading_master" type="submit" style="float: right;"   class="btn btn-warning btn-round">Submit</button><br><br><br>
                                                                    ...
                                                                    <div class="row">
                                                                        ...
                                                                        while ($row = $stm->fetch(PDO::FETCH_ASSOC)) {
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td ><input value="<?php echo $row['Percentage']; ?>" name="pecentage[]" type="text" required=""/></td>

                                                                              <input value="<?php echo $row['GradingMasterID']; ?>" name="grading_id[]" type="hidden" required=""/>
