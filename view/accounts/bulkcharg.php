...
if (isset($_GET['term_id'])){
    ...
    $is_exists = SuperModel::check_if_fee_exists($term_id,$tenant_id);
    
if($is_exists['IsExists'] == 1)
{
     $stm = SuperModel::get_fee_charge_by_id($term_id,$tenant_id,1);
}else {
    
     $stm = SuperModel::get_default_fee_charge($term_id,$tenant_id);
}
    
   
}else {
    $term_id=0;
    $stm = SuperModel::get_fee_charge_by_id($term_id,$tenant_id,2);
}


$stm_term_data = SuperModel::get_active_terms($tenant_id);
$stm_active_term_data = SuperModel::get_sys_active_terms($tenant_id);
?>
<!DOCTYPE html>
<html lang="en">
                                                                ...
                                                                <div class="col-md-4">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <div class="form-select-list">
                                                                            <select  required="" class="form-control custom-select-value" name="term_id">
                                                                 ...
                                                                 <div class="col-md-4">
                                                                    <div class="form-group">
                                                                        <br>
                                                                        <input name="btn_load_grade_fees" type="submit" value="Load" class="btn btn-grd-primary">
                                                                        
                                                                        <?php 
                                                                        if (isset($_GET['term_id'])){
                                                                            $is_exists = SuperModel::check_if_fee_exists($term_id,$tenant_id);
                                                                        if ($is_exists['IsExists']==0 && $stm_active_term_data['TermMasterID'] == $_GET['term_id'] ){
                                                                            
                                                                            echo '<input name="btn_charge_student" type="submit" value="Charge" class="btn btn-grd-success">';
                                                                        }else {}
                                                                        } 
                                                                            ?>
                                                                ...
                                                                <table id="" class="table table-striped table-bordered nowrap">
                                                                    ...
                                                                    <tbody>
                                                                        ...
                                                                        while ($row = $stm->fetch(PDO::FETCH_ASSOC)) {
                                                                            ...
                                                                            <tr>
                                                                                  <td></td>
                                                                                  <input required="" value="<?php echo $row['GradeMasterID']; ?>"   name="grade_id[]" type="hidden" >
                                                                                  <input required="" value="<?php echo $row['Grade']; ?>"   name="grade[]" type="hidden" > 
                                                                                <td><?php echo $row['Grade']; ?></td>

                                                                                <td> <input required=""  value="<?php echo $row['Amount']; ?>"  name="amount[]" type="text" ></td>
                                                                          
                                                                               
                                                                                <td><?php echo $row['UpdatedOn']; ?></td>
                                                                                <td><?php echo $row['UpdatedBy']; ?></td>
                                                                                <td><?php echo $row['IsCharged']; ?></td>
