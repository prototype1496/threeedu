...
<div class="card-block">
   ...
   <div class="col-sm-12">
       <div class="row">
           ...
           if (!isset($_GET['student_public_id'])){
               ...
               echo '<div id="assesmenttypeid" style="padding: 8px 30px 8px 30px;" class="col-sm-12 col-xl-3 m-b-30">
               <input  type="text" required="" name="paid_amount" class="form-control" placeholder="Amount" />  
 ...
 <div id="assesmenttypeid" class="col-sm-12">
  ...
  <div id="assesmenttypeid" class="col-sm-12 col-xl-3 m-b-20">
      <button class="form-control btn-info align-items-end" name="btn_load_transactions" value="btn_load_transactions" type="submit" >Load Transactions</button>
           ...
           if (!isset($_GET['student_public_id'])){
               ...
               echo ' <div id="assesmenttypeid" class="col-sm-12 col-xl-3 m-b-20">
     
     <button class="form-control btn-info align-items-end" name="btn_post_payment" value="btn_post_payment" type="submit" >Post Payment</button>
