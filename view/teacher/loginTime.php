                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <div class="card">
                                            ...
                                            <div class="col-sm-12">
                                                <div class="row">
                                                    <form name="signInLogForm" method="post"
                                                          class="col-sm-12 row"
                                                          onsubmit="event.preventDefault();"
                                                          action="../../controller/super/ActionPerformed.php">
                                                        <input hidden value="loginTime" id="loginBtnClicked"
                                                        ...
                                                        <div style="padding: 8px 30px 8px 30px;"
                                                            ...
                                                            <button class="col-sm-12 btn btn-primary btn-flat "
                                                                    name="startShift"
                                                                    type="submit"
                                                                    onclick="submitForm('Start shift')">
                                                                Start Shift
                                                            </button>
                                                        </div>
                                                        <div style="padding: 8px 30px 8px 30px;"
                                                        ...
                                                        <div style="padding: 8px 30px 8px 30px;"
                                                            ...
                                                            <h3>Start
                                                                <?php
                                                                if (isset($currentSignInDetails['SignIn'])) {
                                                                    echo $currentSignInDetails['SignIn'];
                                                                } else {
                                                                    echo "00:00";
                                                                }
                                                                ?>
                                                        ...
                                                        <div style="padding: 8px 30px 8px 30px;"
                                                            ...
                                                            <h3>End
                                                                <?php
                                                                if (isset($currentSignInDetails['SignOut'])) {
                                                                    echo $currentSignInDetails['SignOut'];
                                                                } else {
                                                                    echo "00:00";
                                                                }
                                                                ?>
                                            ...
                                            <div class="card-block">
                                                <div class="dt-responsive table-responsive">
                                                    <table id="excel-bg"
                                                        ...
                                                        <tbody>
                                                        <?php while ($row = $signInDetails->fetch(PDO::FETCH_ASSOC)) { ?>
                                                            <tr>
...
<script>
    function submitForm(btnName) {
        const loginTime = document.getElementById('loginBtnClicked')
        loginTime.value = btnName;
        console.log(loginTime.value)
        console.log("working")
        document.forms["signInLogForm"].submit();
    }
</script>
