                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="media-left">
                                                                <a href="#" class="profile-image">
                                                                    <img class="user-img img-100"
                                                                         src="<?php echo $get_stuednt_details['ProfilePic']; ?>"
                                                                         alt="user-img">
                                                                </a>
                                                            </div>
                                        ...
                                        <div class="col-lg-12">
                                            ...
                                            <div class="tab-header card">
                                                <ul class="nav nav-tabs md-tabs tab-timeline" role="tablist" id="mytab">
                                                    ...
                                                    <li class="nav-item">
                                                        <a class="nav-link" data-toggle="tab" href="#binfo" role="tab">Time
                                                            Table</a>
                                                        <div class="slide"></div>
                                                    </li>
                                                    <li class="nav-item">
                                                    ...
                                                    <li class="nav-item">
                                                        <a class="nav-link" data-toggle="tab" href="#review" role="tab">Academic
                                                            Results</a>
                                                        <div class="slide"></div>
                                                    </li>
                                                </ul>
                                                                                ...
                                                                                <div class="col-lg-12 col-xl-6">
                                                                                    <div class="table-responsive">
                                                                                        <table class="table">
                                                                                            <tbody>
                                                                                            <tr>
                                                                                                <th scope="row">Student
                                                                                                    No
                                                                                                </th>
                                                                                                <td>
                                                                                                    <a href="#!"><?php echo $get_stuednt_details['StudenNo']; ?></a>
                                                                                                </td>
                                                                                            </tr>
                                                                                            <tr>
                                                                                                <th scope="row">Email
                                                                                                ...
                                                                                                <td><a href="#!"><span
                                                                                                                class="__cf_email__"><?php echo $get_stuednt_details['EmailAddress']; ?></span></a>
                                                                                                </td>
                                                                                            </tr>
                                                                                            <tr>
                                                    ...
                                                    <div class="card">
                                                        ...
                                                        <div class="card">
                                                            <?php if (isset($classname)) {
                                                                ...
                                                                <h2><b>Class Time Table
                                                                        For <?php echo $classname; ?></b></h2><br>
                                                            ...
                                                            <div class="card">
                                                                <div class="card-header contact-user">
                                                                    <img class="img-radius img-40"
                                                                         src="<?php echo $get_stuednt_details['PicURL']; ?>"
                                                                         alt="School Logo">
                                                                    <h5 class="m-l-10">History</h5>
                                                                </div>
                                                                <div class="card-block">
                                                                    <ul class="list-group list-contacts">
                                                                        <li class="list-group-item active"><a href="#">Total
                                                                                Attendance</a></li>
                                                                        <li class="list-group-item"><a href="#">Present
                                                                                Days: 0</a></li>
                                                                        <li class="list-group-item"><a href="#">Absent
                                                                                Days: 0</a></li>
                                                                    </ul>
                                                                </div>
...
<script data-cfasync="false" src="../../files/email-decode.min.js"></script>
...
<script type="fc62f3ba96b90a09d14681a9-text/javascript"
        src="../../files/bower_components/datedropper/js/datedropper.min.js"></script>

<script src="../../files/bower_components/datatables.net/js/jquery.dataTables.min.js"
        type="fc62f3ba96b90a09d14681a9-text/javascript"></script>
...
<script src="../../files/assets/pages/chart/echarts/js/echarts-all.js"
        type="fc62f3ba96b90a09d14681a9-text/javascript"></script>
...
<script src="../../files/rocket-loader.min.js" data-cf-settings="fc62f3ba96b90a09d14681a9-|49" defer=""></script>
</body>
