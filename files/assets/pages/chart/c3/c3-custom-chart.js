...
$(document).ready(function() {
    ...
    var chart = c3.generate({
        ...
        data: {
            columns: [
                ['Current_Performance', 20, 35, 70, -1, 0, 32 ],
                ['Average_Performance', 13, 10, 18, 20, 15, 50]
            ],
            types: {
                Current_Performance: 'area-spline',
                Average_Performance: 'area-spline'
                // 'line', 'spline', 'step', 'area', 'area-step' are also available to stack
            },
            colors: {
                Current_Performance: 'rgba(1, 192, 200, 0.92)',
                Average_Performance: 'rgba(26, 188, 156, 0.93)'
            },
            groups: [
                ['Current_Performance', 'Average_Performance']
            ]
        }
    });
