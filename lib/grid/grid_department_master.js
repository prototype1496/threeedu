    ...
    $(".add-new").click(function () {
        ...
        var row = '<tr>' +
               ...
               <input class="form-control" type="hidden" name="grade_public_id[]" ></td>' +
                '<td><input class="form-control" id="dpt_short_name" name="dpt_short_name[]" type="text"  placeholder="Enter Short Name">\n\
                   </td>' +
    ...
    $(document).on("click", ".add", function () {
        ...
        if (!empty) {
            ...
            input_data.each(function () {
                ...
                if (!isDuplicate) {
                   input_department_name.parent("td").html(input_department_name.val() + "<input id='txt_data_name' type='hidden' name='grade_name[]' value='" + input_department_name.val() + "'/><input class='form-control' type='hidden' name='grade_public_id[]' value='" + input_department_name.val() + "'/>");
