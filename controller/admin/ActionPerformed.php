...
if (isset($_POST['btn_reg_pupil'])) {
...
else if (isset($_POST['btn_updat_pupil'])) {

    $StudentNo = trim(filter_input(INPUT_POST, 'student_no', FILTER_DEFAULT));    
    $StudentMasterPublicID = trim(filter_input(INPUT_POST, 'student_master_public_id', FILTER_DEFAULT));
    ...
    if (isset($_FILES["profile_pic"]["name"]) && !empty($_FILES["profile_pic"]["name"])) {
        ...
        if (SuperModel::updat_regitered_pupil($first_name, $last_name, $other_name, $gender_id, $dob, $marital_status_id, $class_id, $subject_code_1, $subject_code_2, $subject_code_3, $subject_code_4, $subject_code_5, $subject_code_6, $subject_code_7, $subject_code_8, $male_gardian_name, $female_gardian_name, $gardian_contact_no, $address, $StudentMasterPublicID, $StudentNo, $location . $file_new_name, $UpdatedBy, $email_address)) {
            move_uploaded_file($file_temp, $location . $file_new_name);
            ...
            function(){
               ...
               $.jnoty('Student Updated Successfully', {
            sticky: false,
            header: 'Success',
            theme: 'jnoty-success',
            close: function() {window.location.replace('/threeedu/view/admin/viwestudent.php')},
            });   
            }); 
            </script>";
        } else {
            ...
            function(){
               ...
               $.jnoty('Student Not Updated Please Try Agin Later', {
            sticky: false,
            header: 'Erro',
            theme: 'jnoty-danger',
            close: function() {window.location.replace('/threeedu/view/admin/studentupdate.php?id=$StudentNo')},
            });   
            }); 
            </script>";
        }
        ...
        $file_new_name = "../../uploads/defult.png";
        if (SuperModel::updat_regitered_pupil($first_name, $last_name, $other_name, $gender_id, $dob, $marital_status_id, $class_id, $subject_code_1, $subject_code_2, $subject_code_3, $subject_code_4, $subject_code_5, $subject_code_6, $subject_code_7, $subject_code_8, $male_gardian_name, $female_gardian_name, $gardian_contact_no, $address, $StudentMasterPublicID, $StudentNo, $file_new_name, $UpdatedBy, $email_address)) {
